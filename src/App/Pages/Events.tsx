		...
		<IonPage>
			...
			<IonContent>
				...
				<div
					...
					<IonCard>
						<Link style={{ textDecoration: "none", color: "black" }} to='/bday'>
							<IonCardHeader>
								<IonCardTitle>Birthday Party Budget</IonCardTitle>
							</IonCardHeader>
							<IonCardContent>
								<div>
									<img
					...
					<IonCard>
						<Link
							...
							<IonCardHeader>
								<IonCardTitle>Sports Event Budget</IonCardTitle>
							</IonCardHeader>
							<IonCardContent>
								<div>
									<img
					...
					<IonCard>
						<Link
							...
							<IonCardContent>
								...
								<IonText>See Budgets Of Your Brand Launchs Event</IonText>
					...
					<IonCard>
						<Link
							...
							style={{ textDecoration: "none", color: "black" }}>
							<IonCardHeader>
								<IonCardTitle>Product Launch Event Budget</IonCardTitle>
							</IonCardHeader>
							<IonCardContent>
								<div>
									<img
					...
					<IonCard>
						<Link
							...
							<IonCardHeader>
								<IonCardTitle>Virtual Event Budget</IonCardTitle>
							</IonCardHeader>
							<IonCardContent>
								<div>
									<img
